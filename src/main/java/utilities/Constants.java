...
public class Constants {
    ...
    //Setting up the URLs
    public static final String URL = JavaHelpers.getPropertyValue(PROPERTY_FILE, "url_DemoBlaze");
    public static final String URLPT = JavaHelpers.getPropertyValue(PROPERTY_FILE,"url_PhpTravels");
